...
export type EditableEquipmentFields = Pick<
  Equipment,
  'marca' | 'modelo' | 'numeroSerie' | 'cargaRefrigerante' | 'ubicacion' | 'observacionesEquipo' | 'activo'
>;
...
export interface EquipmentHistory {
  ...
  openIncidents: import('./incident').Incident[];
  closedIncidents: import('./incident').Incident[];
  observations: Array<{
    fecha: string;
    observacion: string;
    tecnico: string;
