...
export function EquipmentEditor({ equipment, saving, onSave }: EquipmentEditorProps) {
    ...
    >
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-2">
        ...
        <label className="md:col-span-2">
          ...
          <input className="form-input mt-1" value={form.ubicacion} onChange={(event) => update('ubicacion', event.target.value)} />
        </label>
        <label className="md:col-span-2">
