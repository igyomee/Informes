...
const metricLabels: Array<[keyof CenterReport, string]> = [
  ['totalEquiposRevisados', 'Equipos con revision'],
  ['totalRevisiones', 'Ultimas revisiones'],
  ['equiposPendientesRevision', 'Equipos sin revision']
];
    ...
    <section className="space-y-4">
      ...
      <div className="panel overflow-hidden">
        <div className="border-b border-line p-4">
          <h2 className="text-lg font-bold text-ink">Ultima revision por maquina</h2>
          <p className="text-sm text-slate-600">{report.centro}</p>
        </div>
        <div className="overflow-x-auto">
          <table className="min-w-[760px] w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-line">
              {[...report.revisiones].sort(compareByEquipmentCode).map((review) => (
