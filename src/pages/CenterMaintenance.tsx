...
export function CenterMaintenance() {
  ...
  async function saveReviewForMachine(item: Equipment) {
    ...
    if (!technician.trim()) throw new Error('Indica el tecnico responsable.');
    ...
    <div className="space-y-4">
      <section className="panel p-4">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-3">
          ...
          <label>
            <span className="form-label">Tecnico</span>
              ...
              {state.open ? (
                <div className="border-t border-black p-4">
                    ...
                    {isClimate ? (
                      <>
                        ...
                        <input
                          ...
                          placeholder="Carga refrigerante (kg)"
                          inputMode="decimal"
                          onChange={(event) =>
                            setEquipment((current) =>
                  ...
                  <div className="mt-4 flex flex-wrap justify-end gap-2 border-t border-black pt-4">
                    ...
                    <button type="button" className="btn-primary" disabled={state.saving || !state.checklist} onClick={() => void saveMachine(item)}>
