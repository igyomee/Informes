...
const navigation = [
  ...
  { to: '/revision-centro', label: 'Revisión por centro', icon: Wrench },
  { to: '/centros', label: 'Informes por centro', icon: BarChart3 },
      ...
      <header className="sticky top-0 z-20 border-b border-black bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
          <div className="flex items-center gap-3">
            <button className="btn-secondary px-3 md:hidden" type="button" onClick={() => setOpen((value) => !value)} title="Abrir menÃº">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="btn-secondary px-3" type="button" onClick={onLogout} title="Cerrar sesiÃ³n">
      ...
      <div className="mx-auto grid max-w-7xl gap-4 px-4 py-4 md:grid-cols-[240px_1fr]">
        ...
        <main className="min-w-0" key={moduleKey}>
          <Routes>
            ...
            <Route path="/equipos" element={<CenterMaintenance />} />
